...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
        <div class="col-6"><img id = "img" src="http://barathdandu-com.stackstaging.com/p/images/home.jpg" alt="Twitter"></div>
        <div class="col-5">
            ...
            <div class="container h-100">
                <div class="row h-100  align-items-center">
                    <form>
                        ...
                        <a href="https://barathdandu-com.stackstaging.com/p/signup.php" type="button" class="btn btn-primary ">Sign up</a>
                        <br>                       
                        <a  href="https://barathdandu-com.stackstaging.com/p/login.php" type="button" class="btn btn-secondary">Log in</a>
