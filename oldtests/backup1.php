 ...
 if($_GET['sub']=='sb'){
    ...
    if(array_key_exists("email", $_SESSION) && $_SESSION['email']){
        ...
        if(mysqli_connect_error()){
            ...
            $query = "SELECT `id` FROM `twitter` WHERE username = '".mysqli_real_escape_string($link, $_GET['username'])."'";
            ...
            if(mysqli_num_rows($result) > 0){
                ...
                $query = "UPDATE `twitter` SET `username`= '".mysqli_real_escape_string($link, $_GET['username'])."',`piclocation`= '".$_GET['picloc']."' WHERE email = '".$_SESSION['email']."' LIMIT 1";
...
<html>
	...
	<body>
        ...
        <div class="contain" >
            <img id = "log" src="http://barathdandu-com.stackstaging.com/p/images/logowhiteonblack.png" alt="Twitter">
		...
		<div class="container">
            ...
            <div class="row">
				...
				<div class="col-md-4">
					<div class="image_area"  align="center">
						<form method="post">
							<label for="upload_image">
								<img src="/p/images/userIcon.png" id="uploaded_image" class="img-responsive img-circle" />
								<div class="overlay">
                    ...
                    <form method="GET" id = "inp">
                        
                        <label style="text-align:left;" for="username">Enter Username:</label>

                        <input type="text" class="form-control" id="username" name = "username" placeholder="Username" aria-describedby="emailHelp" required  value="<?php if (isset($_GET['username'])) echo $_GET['username']; ?>"/>
                        
                        <input id = "hidinp" type="hidden" name = "picloc" value = "/p/images/userIcon.png"> 
